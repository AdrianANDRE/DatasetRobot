...
Test
    ...
    Given Voici une variable "${dataset}[var]"
...
Test Setup
    ...
    END
    IF    $TEST_134_SETUP_VALUE is not None
        Run Keyword    ${TEST_134_SETUP}
    END
...
Test Teardown
    ...
    IF    $TEST_134_TEARDOWN_VALUE is not None
        Run Keyword    ${TEST_134_TEARDOWN}
    END
